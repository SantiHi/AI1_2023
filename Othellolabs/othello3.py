...
def main(): 
    ...
    printturn(board, determinemoves(board, currenttoken), currenttoken)
    for m in moves:
        if int(m) >= 0: 
            ...
            if(possiblemoves): 
                ...
                pos = determinemoves(board, currenttoken)
                if pos: 
                    printturn(board, pos, currenttoken)
                else: 
                    othertoken, currenttoken = currenttoken, othertoken
                    pos = determinemoves(board, currenttoken)
                    printturn(board, pos, currenttoken)
                ...
                if possiblemoves: 
                    ...
                    if newpos: 
                        ...
                        othertoken, currenttoken = currenttoken, othertoken
                        newpos = determinemoves(board, currenttoken)
                        printturn(board, newpos, currenttoken)
